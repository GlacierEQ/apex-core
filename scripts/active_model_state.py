...
STATIC_ALIASES: Dict[str, Dict[str, Any]] = {
    ...
    "opencode": {
        ...
        "name": "OpenCode Zen Primary (Poolside Laguna)",
        "multimodal": False,
    ...
    "kilo": {
        "id": "openrouter/poolside/laguna-s-2.1:free",
        "name": "Kilo Primary Coder (Poolside Laguna)",
        "multimodal": False,
        "context_length": 256000,
        "engine": "kilo",
    ...
    "kilo/build": {
        "id": "openrouter/poolside/laguna-s-2.1:free",
        "name": "Kilo Software Builder (Poolside Laguna)",
        "multimodal": False,
        "context_length": 256000,
        "engine": "kilo",
        "category": "KiloCode Engine",
    ...
    "kilo/operator": {
        "id": "openrouter/nvidia/nemotron-3.5-lightning:free",
        "name": "Kilo Master Operator (Nemotron 3.5 Lightning)",
        "multimodal": False,
        "context_length": 976000,
        "engine": "kilo",
        "category": "KiloCode Engine",
    ...
    "kilo/architect": {
        ...
        "name": "Kilo Architect (Nemotron 3 Ultra 1M ctx)",
        "multimodal": False,
    ...
    "kilo/review": {
        "id": "openrouter/poolside/laguna-s-2.1:free",
        "name": "Kilo Code Reviewer (Poolside Laguna)",
        "multimodal": False,
        "context_length": 256000,
        "engine": "kilo",
        "category": "KiloCode Engine",
    ...
    "kilo/simplify": {
        ...
        "name": "Kilo Code Simplifier (Cohere North Mini Code)",
        "multimodal": False,
    ...
    "kilo/skeptic": {
        ...
        "name": "Kilo Adversarial Skeptic (GLM 5.2 Reasoning)",
        "multimodal": False,
        "context_length": 250000,
        "engine": "kilo",
        "category": "KiloCode Engine",
    ...
    "kilo/fast": {
        ...
        "name": "Kilo Fast Subagent (Liquid LFM 2.5)",
        "multimodal": False,
        "context_length": 65536,
        "engine": "kilo",
        "category": "KiloCode Engine",
    ...
    "kilo/data": {
        "id": "openrouter/cohere/north-mini-code:free",
        "name": "Kilo Data Analyst (Cohere North Mini Code)",
        "multimodal": False,
        "context_length": 250000,
        "engine": "kilo",
        "category": "KiloCode Engine",
    ...
    "kilo/docs": {
        ...
        "name": "Kilo Docs Specialist (MiniMax M3 1M ctx)",
        "multimodal": True,
        "context_length": 1048576,
        "engine": "kilo",
        "category": "KiloCode Engine",
